...
$sql="SELECT guid from $tab_post where post_excerpt='adminlogo'";
$admin=$wpdb->get_row($sql);
echo '<style type="text/css">
h1 a {background:#0085BA url("'.$admin->guid.'") !important; background-repeat:no-repeat!important;background-size: 90%!important;border-radius:40px!important;}
</style>';
}
...
//自定义图片上传函数
//
function uploadimg($name,$dir='',$allow_type=array('jpg','gif','png','jpeg')){
	$pre_dir=get_template_directory_uri();
	$dir=$pre_dir.'/uploads';
    // 1.判断错误
    //
